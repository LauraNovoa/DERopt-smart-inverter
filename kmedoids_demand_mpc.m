...
%Pick number of days of weekday and wekend to use in the k-medoids
week_k = 5; %2
wknd_k = 2; %1

%Get month, day, and hour as column vectors 
...
%Reshape data into 3D vector day x hour x bldg for using it on k-medeoids
for  bldg=1:K
...
%Build k-sampled elec vector
elecsamplesplit = [C3;C6;C5;C2;C1;C4]; %Starting on a week on winter (January)

%Reshape it back to hour x bldg
for bldg=1:K
