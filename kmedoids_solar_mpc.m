...
[idx1,C1,sumd,d,midx,info] = kmedoids(splitsummer,(week_k+wknd_k),'Distance','cityblock');
[idx2,C2,sumd,d,midx,info] = kmedoids(splitwinter,(week_k+wknd_k),'Distance','cityblock');
[idx3,C3,sumd,d,midx,info] = kmedoids(splitspring,(week_k+wknd_k),'Distance','cityblock');

%When week_k = 2 and wknd_k = 1
